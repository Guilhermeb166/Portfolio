        ...
        <div className={styles.contacts_wrapper}>
            ...
            <div className={styles.social_wrapper}>
                <div className={styles.social_control}>
                    <a href="mailto:guilhermebarroso166@gmail.com" target='_blank' rel="noreferrer">
                ...
                <div className={styles.social_control}>
                    <a href="https://wa.me/5585997407364" target='_blank' rel="noreferrer">
                ...
                <div className={styles.social_control}>
                    <a href="https://github.com/Guilhermeb166" target='_blank' rel="noreferrer">
                ...
                <div className={styles.social_control}>
                    <a href="https://www.linkedin.com/in/guilherme-barroso-98773b269/" target='_blank' rel="noreferrer">
